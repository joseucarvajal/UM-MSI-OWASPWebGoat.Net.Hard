                ...
                <ContentTemplate>
                    ...
                    <div class="accountInfo">
                        ...
                        <fieldset class="login">
                            ...
                            <asp:TextBox ID="txtAddress" runat="server" CssClass="textEntry" MaxLength="60"></asp:TextBox>
                            <br />
                            <asp:Label ID="lblCity" runat="server" Text="City"></asp:Label><br />
                            <asp:TextBox ID="txtCity" runat="server" CssClass="textEntry" MaxLength="15"></asp:TextBox>
                            <br />
                            <asp:Label ID="Label2" runat="server" Text="Region/State"></asp:Label><br />
                            <asp:TextBox ID="txtRegion" runat="server" CssClass="textEntry" MaxLength="15"></asp:TextBox>
                            <br />
